    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(choices=[('Entry', 'Entry'), ('Quote', 'Quote'), ('Ordered', 'Ordered'), ('In Process', 'In Process'), ('Cancelled', 'Cancelled'), ('Enroute', 'Enroute'), ('Delivered', 'Delivered'), ('Invoiced', 'Invoiced'), ('Completed', 'Completed')], default='Entry', max_length=100, no_check_for_status=True, verbose_name='status')),
                ...
                ('subtotal', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='AUD', max_digits=19)),
                ('delivery_due_date', models.DateTimeField(blank=True, default=None, null=True)),
